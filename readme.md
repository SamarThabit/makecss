...
Преди да пристъпите към същинска инсталация е небходимо да отворите файла *setup/setup.js* и да конфигурирате системата спрямо вашите нужди.
...
Отворете конзолата и изберете пътя до проекта:
